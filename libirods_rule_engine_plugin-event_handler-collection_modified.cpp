...
namespace
{
	...
	const pc::event_map_type p2e{{"coll_create", "CREATE"}, {"phy_path_reg", "REGISTER"}, {"rm_coll", "REMOVE"}};
	...
	auto collection_handler(const std::string& _rule_name, const pc::arguments_type& _arguments, ruleExecInfo_t* _rei)
		-> eh::handler_return_type
	{
		auto it = pc::advance_or_throw(_arguments, 2);
